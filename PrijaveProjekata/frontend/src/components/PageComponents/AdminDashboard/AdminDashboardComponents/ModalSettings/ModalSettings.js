...
const ModalSettings = ({}) => {
  const { modalSettingsIsOpen, setModalSettingsIsOpen } = useContext(
      ...
      <div className={Style.ModalContainerOverlay}>
        <div className={Style.Modal}>
          ...
          <div className={Style.ModalContent}>
            <h4 className="title-font" style={{ marginTop: "10px" }}>
              Dekan
            </h4>
            ...
            <div className={Style.DepartmentsInfo}>
              ...
              <div className={Style.NewDepartmentContainer}>
                <input
                  className={Style.NewDepartmentName}
                  onChange={handleDepartmentName}
                  type="text"
                  placeholder="ime zavoda..."
                ></input>
                <input
                  className={Style.NewDepartmentHead}
                  onChange={handleDepartmentHead}
                  type="text"
                  placeholder="ime nositelja zavoda..."
                ></input>
                <button
                  className={Style.AddNewDepartmentButton}
                  onClick={() => handleCreateDepartment(newDepartmentData)}
                >
                  DODAJ NOVI ZAVOD
                </button>
              </div>
