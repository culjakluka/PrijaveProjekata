...
// styles
import Style from './NumberInputSelectFirstForm.module.css'

// context
import { FirstInputFormDataContext } from '../../../context/FirstInputFormDataContext';

const NumberInputSelectFirstForm = ({ name, label, initialValue, setSpecificState, currencyOrPercentage }) => {
    ...
    const { totalValue } = useContext(FirstInputFormDataContext);
...
export default NumberInputSelectFirstForm;
